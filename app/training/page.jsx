    ...
    <div class="w-auto">
      ...
      <div class="container my-5 d-flex flex-column gap-5">
        ...
        <div>
          ...
          <p>We will use fault trees to model the relationships between these failures. A fault tree is a graphical representation of how different failures can lead to a top-level system failure. Failure modes are classified based on their severity (critical, degradation, or incipient).</p>
          <p>To provide a more realistic simulation, we will create digital twins for each sensor. These digital twins are machine learning models (like regression and time series models) trained on historical sensor data. We can use these digital twins to forecast future sensor readings and compare them to actual readings to detect anomalies.</p>
